output "data_factory_linked_service_postgresqls_id" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_service_postgresql.data_factory_linked_service_postgresqls : k => v.id if v.id != null && length(v.id) > 0 }
}
output "data_factory_linked_service_postgresqls_additional_properties" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_service_postgresql.data_factory_linked_service_postgresqls : k => v.additional_properties if v.additional_properties != null && length(v.additional_properties) > 0 }
}
output "data_factory_linked_service_postgresqls_annotations" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_service_postgresql.data_factory_linked_service_postgresqls : k => v.annotations if v.annotations != null && length(v.annotations) > 0 }
}
output "data_factory_linked_service_postgresqls_connection_string" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_service_postgresql.data_factory_linked_service_postgresqls : k => v.connection_string if v.connection_string != null && length(v.connection_string) > 0 }
}
output "data_factory_linked_service_postgresqls_data_factory_id" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_service_postgresql.data_factory_linked_service_postgresqls : k => v.data_factory_id if v.data_factory_id != null && length(v.data_factory_id) > 0 }
}
output "data_factory_linked_service_postgresqls_description" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_service_postgresql.data_factory_linked_service_postgresqls : k => v.description if v.description != null && length(v.description) > 0 }
}
output "data_factory_linked_service_postgresqls_integration_runtime_name" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_service_postgresql.data_factory_linked_service_postgresqls : k => v.integration_runtime_name if v.integration_runtime_name != null && length(v.integration_runtime_name) > 0 }
}
output "data_factory_linked_service_postgresqls_name" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_service_postgresql.data_factory_linked_service_postgresqls : k => v.name if v.name != null && length(v.name) > 0 }
}
output "data_factory_linked_service_postgresqls_parameters" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_service_postgresql.data_factory_linked_service_postgresqls : k => v.parameters if v.parameters != null && length(v.parameters) > 0 }
}
